...
Check version number in setup.json and aiida_defect/__init__.py and make sure
they match.
"""
...
import aiida_defect  # pylint: disable=wrong-import-position
version = aiida_defect.__version__
