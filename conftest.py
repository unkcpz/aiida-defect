...
def aiida_localhost_computer(new_workdir):
    ...
    """
    from aiida_defect.helpers import get_computer
...
def aiida_code(aiida_localhost_computer):
    ...
    """
    from aiida_defect.helpers import get_code

    code = get_code(entry_point='defect', computer=aiida_localhost_computer)
